...
prefix = gsub('_for_annotatr.txt','', filename)
...
readr::write_tsv(x = ar, path = sprintf('%s/%s_annotation_counts.txt',output_dir, prefix))
...
if(class_type == 'simple' || class_type == 'PePr') {
	...
	cocounts_png = sprintf('%s%s_cocounts.png',output_dir,prefix)
...
content =paste('<html> this is the test file' , '<img src= "cat_prop_genes_png" alt="box plot" style="width:304px;height:228px;">', '/html')
